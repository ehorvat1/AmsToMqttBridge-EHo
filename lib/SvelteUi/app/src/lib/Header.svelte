...
// import DownloadIcon from "./DownloadIcon.svelte";    EHorvat disabled consent stuff  
  ...
  /*  EHorvat disabled consent stuff  
    ...
    sysinfoStore.subscribe(update => {
      sysinfo = update;
//      if(update.fwconsent === 1) {    // EHorvat disabled consent stuff  
//        getGitHubReleases();          // EHorvat disabled consent stuff  
//      }                               // EHorvat disabled consent stuff  
    });

//    gitHubReleaseStore.subscribe(releases => {                    // EHorvat disabled consent stuff  
//     nextVersion = getNextVersion(sysinfo.version, releases);     // EHorvat disabled consent stuff  
//    });                                                           // EHorvat disabled consent stuff  
</script>
