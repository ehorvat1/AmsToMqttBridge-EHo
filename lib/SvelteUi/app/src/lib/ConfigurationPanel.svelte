...
let uiElements = [{
        ...
        name: 'Last Bill',    // EHorvat: new last_counter_value (was Reactive)
        key: 'r'
    },{
        name: 'Real time data',
        key: 'c'
        ...
        name: 'Minute Plot',   // EHorvat: new minute plot .... also add "q" to config.json and to configuration at "u"
        key: 'q'
    },{
        name: 'Hour Plot',   // EHorvat: new minute plot.... also add "h" to config.json
        key: 'h'
    },{
        name: 'Day plot',
        key: 'd'
    ...
    let configuration = {
        ...
        p: {
            e: false, t: '', r: '', c: '', m: 1.0, f: null, i: null, y: 123456789, d:'', z: 123456789, g: '' //EHorvat added ", i: null" for fixed income refund, and "y" "d" "z" "g" for last_countet
        },
        d: {
            s: false, t: false, l: 5
        },
        u: {
            i: 0, e: 0, v: 0, a: 0, r: 0, c: 0, t: 0, p: 0, q: 0, h: 0, d: 0, m: 0, s: 0    //EHorvat added q: 0, h: 0, for minute plot and hour plot
        },
        i: {
            h: { p: null, u: true },
            a: null,
...
<form on:submit|preventDefault={handleSubmit} autocomplete="off">
    <div class="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2">
            ...
            <div class="my-1">
                ...
                <div>
                    ...
                    <select name="pc" bind:value={configuration.p.c} class="in-l">
                        {#each ["EUR","NOK","SEK","DKK","CHF"] as c}  <!-- EHorvat: Added "CHF" to currency list and moved EUR to 1st element-->
            ...
            <div class="my-1">
                <div class="flex">
                    ...
                    <div class="w-1/2">     <!-- EHorvat: Added new fixed income price / refund-->
                        Fixed refund<br/>
                        <input name="pi" bind:value={configuration.p.i} type="number" min="0.001" max="65" step="0.001" class="in-f tr w-full"/>
                    </div>
                    <div class="w-1/2">
                        Multiplier<br/>
        ...
        {/if}
        <div class="cnt">
            <strong class="text-sm">Dashboard setting</strong>
        ...
        <div class="cnt"> <!-- EHorvat: Added new last_counter_value -->
            <strong class="text-sm">last energy bill</strong>
            <div class="my-1"> 
                Meter counter [kWh] Import<br/>
                <input name="py" bind:value={configuration.p.y} type="number" min="0" max="2147483646" class="in-s"/>
            </div>
            <div class="my-1">
                Date of Import counter (max. 16 char.)<br/>
                <input name="pd" bind:value={configuration.p.d} type="text" class="in-s">
            </div>
            <div class="my-1">
                Meter counter [kWh] Export<br/>
                <input name="pz" bind:value={configuration.p.z} type="number" min="0" max="2147483646" class="in-s"/>
            </div>
            <div class="my-1">
                Date of Export counter (max. 16 char.)<br/>
                <input name="pg" bind:value={configuration.p.g} type="text" class="in-s">
            </div>         
        </div>
        <div class="cnt">
