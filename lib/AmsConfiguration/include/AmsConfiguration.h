...
#define EEPROM_CHECK_SUM 104 // Used to check if config is stored. Change if structure changes. EHorvat new fixed income price / refund  was 103
...
#define CONFIG_WIFI_START 402					//EHorvat new fixed income price / refund  was 360 ... last_counter_value +22...+20 ab 8.8.2023
#define CONFIG_ENERGYACCOUNTING_START 618		//EHorvat new fixed income price / refund  was 576
#define CONFIG_WEB_START 690					//EHorvat new fixed income price / refund  was 648
#define CONFIG_DEBUG_START 866					//EHorvat new fixed income price / refund  was 824
#define CONFIG_DOMOTICZ_START 898				//EHorvat new fixed income price / refund  was 856 
#define CONFIG_NTP_START 914					//EHorvat new fixed income price / refund  was 872
#define CONFIG_MQTT_START 1046					//EHorvat new fixed income price / refund  was 1004
#define CONFIG_HA_START 1722					//EHorvat new fixed income price / refund  was 1680
...
struct EntsoeConfig {
	...
	bool enabled;
	uint16_t fixedPrice;
	uint16_t fixedRefund;		 //EHorvat new fixed income price ... now 67 bytes EEPROM
...
private:
	...
	bool relocateConfig103(); // 2.2.12 through 2.2.21  ... new 104 by EHorvat for new fixed income price / refund  and last_counter_value
