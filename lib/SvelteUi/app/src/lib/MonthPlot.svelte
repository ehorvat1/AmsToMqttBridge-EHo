...
// EHorvat: Added color2: '#407038' 
        ...
        config = {
//          EHorvat translated to german was: title: "Energy use last " + lm.getDate() + " days (kWh)",
            title: "Elektrische Energie letzte " + lm.getDate() + " Tage (kWh)",
            height: 226,
            width: 1520,
