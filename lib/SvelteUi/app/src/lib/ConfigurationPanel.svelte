...
let uiElements = [{
        ...
        name: 'Letzte Abrechnung',    // EHorvat: new last_counter_value (was Reactive)
        key: 'r'
    },{
        name: 'Aktuelle Daten',
        key: 'c'
        ...
        name: 'Minuten Plot',   // EHorvat: new minute plot .... also add "q" to config.json and to configuration at "u"
        key: 'q'
    },{
        name: 'Stunden Plot',   // EHorvat: new minute plot.... also add "h" to config.json
        key: 'h'
    },{
        name: 'Tages plot',
        key: 'd'
...
<form on:submit|preventDefault={handleSubmit} autocomplete="off">
    <div class="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2">
        ...
        {/if}
        <div class="cnt">
            <!-- EHorvat: translated next line text was: User interface -->
        ...
        <div class="cnt"> <!-- EHorvat: Added new last_counter_value -->
            ...
            <div class="my-1">
                Info zu Z&auml;hlerstand Imp. (max. 16 Zeichen)<br/>
            ...
            <div class="my-1">
                Info zu Z&auml;hlerstand Exp. (max. 16 Zeichen)<br/>
